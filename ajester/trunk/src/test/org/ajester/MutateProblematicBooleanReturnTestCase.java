...
public class MutateProblematicBooleanReturnTestCase extends TestCase {
	public void testMutatingIrrelevantMethodLeavesTestsStillPassing() throws Exception {
		Report report = new TestRunnerWrapper().run(ProblematicBooleanReturnTestCase.class,
			new IfStatementInstructionMutator(new CodeLocationMatcher(ProblematicBooleanReturn.LOCATION)));
